...
![启动加载](assets/01-loading.png)

### 主游戏界面

![主游戏界面](assets/02-game-main.png)

### 转动结果

![转动结果](assets/03-spin-result.png)

### 免费游戏触发

![免费游戏触发](assets/04-game-free.png)

### 免费游戏转动

![免费游戏转动](assets/05-game-free-spin.png)
